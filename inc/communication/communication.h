...
typedef void (* tx_indication)(uint8_t protocol_id);
typedef void (* rx_confirmation)(uint8_t protocol_id);

typedef uint8_t (* comm_registe_txrx_func)(tx_indication tx_ind, rx_confirmation rx_conf,
        uint8_t protocol_id);
typedef struct uxrCommunication
{
    ...
    comm_registe_txrx_func comm_registe_txrx;
    uint16_t mtu;
